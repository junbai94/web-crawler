...
proxyDict = {
    "http"  : "http://ps811474:Price003@shan-prox-mwg2.ap.corp.cargill.com:4200",
     "https" : "http://ps811474:Price003@sing-prox-mwg1.ap.corp.cargill.com:4200",
}
...
def _get_mysteel_price(
    ...
    try:
        ...
        #b) construction material
            ...
            if col_idx:
                price = (rows[2].find_all("td")[col_idx].text.strip())
            else:
                logger.warn("[_get_mysteel_price] missing price {} for this date {}. Is the login ID still working?".format(url,the_date))
            return price
...
def update_prices_xlsx(
                        ...
                        temp_data_path = 'S:/Ferrous/China Steel Team/China Steel Analysis',
                        price_xlsx_network_path = "S:/Ferrous/China Steel Team/China Steel Analysis/AM PM Price/Daily Steel price Update.xlsx",
                        price_xlsx_network_tmp_path = "//sgsing022m/sing8data/ETIA/DRY/FERROUS/Steel/Wei/Prices_tmp.xlsx",
                        price_xlsx_local_relative_path = "/AM PM Price/price.xlsx",
    ...
    try:
        ...
        session_requests = _get_login_session(type="mysteel")
            #get mysteel price
        prices_mysteel = [
            {"cell_col_id":"AO","value":None,"name":"Taian HRC","payload":{"url":"http://list1.mysteel.com/market/p-231-----010103-0-01010208-------1.html","mode":"construction","price_name":"泰安市场热轧板卷价格行情","product":"热轧板卷","spec":"5.5-11.5*1500*C","origin":"中铁装备"}},
            {"cell_col_id":"F","value":None,"name":"Shanghai HRC","payload":{"url":"http://list1.mysteel.com/price/p-10058--010103--1.html","mode":"hrc","price_name":None,"area":"上海","spec":"4.75热轧板卷"}},
            {"cell_col_id":"G","value":None,"name":"Guangzhou HRC","payload":{"url":"http://list1.mysteel.com/price/p-10058--010103--1.html","mode":"hrc","price_name":None,"area":"广州","spec":"4.75热轧板卷"}},
            {"cell_col_id":"H","value":None,"name":"Tianjin HRC","payload":{"url":"http://list1.mysteel.com/price/p-10058--010103--1.html","mode":"hrc","price_name":None,"area":"天津","spec":"4.75热轧板卷"}},
            {"cell_col_id":"I","value":None,"name":"Shanghai CRC","payload":{"url":"http://list1.mysteel.com/price/p-10053--010104--1.html","mode":"crc","price_name":None,"area":"上海","spec":"1.0mm"}},
            {"cell_col_id":"J","value":None,"name":"Guangzhou CRC","payload":{"url":"http://list1.mysteel.com/price/p-10053--010104--1.html","mode":"crc","price_name":None,"area":"广州","spec":"1.0mm"}},
            {"cell_col_id":"K","value":None,"name":"Tianjin CRC","payload":{"url":"http://list1.mysteel.com/price/p-10053--010104--1.html","mode":"crc","price_name":None,"area":"天津","spec":"1.0mm"}},
            
            {"cell_col_id":"B","value":None,"name":"Shanghai Rebar","payload":{"url":"http://list1.mysteel.com/market/p-228-15278-----0--------1.html","mode":"construction","price_name":"上海市场建筑钢材价格行情","product":"螺纹钢","spec":"Φ16-22","origin":"萍钢"}},
            {"cell_col_id":"T","value":None,"name":"Shanghai Rebar","payload":{"url":"http://list1.mysteel.com/market/p-228-15278-----0--------1.html","mode":"construction","price_name":"上海市场建筑钢材价格行情","product":"螺纹钢","spec":"Ф16-25","origin":"申特"}},
            {"cell_col_id":"U","value":None,"name":"Shanghai Rebar","payload":{"url":"http://list1.mysteel.com/market/p-228-15278-----0--------1.html","mode":"construction","price_name":"上海市场建筑钢材价格行情","product":"螺纹钢","spec":"Ф16-25","origin":"联鑫黄海"}},
            {"cell_col_id":"V","value":None,"name":"Shanghai Rebar","payload":{"url":"http://list1.mysteel.com/market/p-228-15278-----0--------1.html","mode":"construction","price_name":"上海市场建筑钢材价格行情","product":"螺纹钢","spec":"Ф16-25","origin":"连云港兴鑫"}}, 
            {"cell_col_id":"D","value":None,"name":"Guangzhou Rebar","payload":{"url":"http://list1.mysteel.com/market/p-228-15584-----0--------1.html","mode":"construction","price_name":"广州市场建筑钢材价格行情","product":"螺纹钢","spec":"Ф18-25","origin":"萍钢"}},
            {"cell_col_id":"E","value":None,"name":"Tianjin Rebar","payload":{"url":"http://list1.mysteel.com/market/p-228-----010101-0-0104-------1.html","mode":"construction","price_name":"天津市场建筑钢材价格行情","product":"螺纹钢","spec":"Ф16","origin":"东华钢铁"}},
            {"cell_col_id":"O","value":None,"name":"Tangshan Billet","payload":{"url":"http://list1.mysteel.com/market/p-356-14542-----0--------1.html","mode":"furnace_raw","price_name":"唐山钢厂方坯价格行情","product":"方坯","spec":"150*150","origin":"安丰(秦皇岛)"}},
            {"cell_col_id":"AF","value":None,"name":"JS Billet Price","payload":{"url":"http://list1.mysteel.com/market/p-356-----030701-0-0101-------1.html","mode":"js_furnace_raw","price_name":"江苏市场方坯价格行情","product":"150*150","spec":"Q235","origin":"长强"}},
            {"cell_col_id":"AG","value":None,"name":"BJ RB HBIS","payload":{"url":"http://list1.mysteel.com/market/p-228-12911-----0--------1.html","mode":"construction","price_name":"北京市场建筑钢材价格行情","product":"螺纹钢","spec":"Ф18-25","origin":"河钢宣钢"}}, 
            {"cell_col_id":"AJ","value":None,"name":"BJ Donghua","payload":{"url":"http://list1.mysteel.com/market/p-228-12911-----0--------1.html","mode":"construction","price_name":"北京市场建筑钢材价格行情","product":"螺纹钢","spec":"Ф18-25","origin":"东华钢铁"}}, 
            {"cell_col_id":"AK","value":None,"name":"BJ Xinxing","payload":{"url":"http://list1.mysteel.com/market/p-228-12911-----0--------1.html","mode":"construction","price_name":"北京市场建筑钢材价格行情","product":"螺纹钢","spec":"Ф16-25","origin":"新兴铸管"}}, 
            {"cell_col_id":"W","value":None,"name":"Tangshan Rebar","payload":{"url":"http://list1.mysteel.com/market/p-228-----010101-0-0104-------1.html","mode":"construction","price_name":"唐山市场建筑钢材价格行情","product":"螺纹钢","spec":"Ф18-25","origin":"东海特钢"}},
            {"cell_col_id":"X","value":None,"name":"Strip","payload":{"url":"http://list1.mysteel.com/market/p-235-----010108-0-01040302-------1.html","mode":"furnace_raw","price_name":"唐山钢企145mm热轧带钢出厂价格","product":"热轧带钢","spec":"2.5*145","origin":"金港"}},
            {"cell_col_id":"Y","value":None,"name":"Angle steel 50*5 日度","payload":{"url":"http://list1.mysteel.com/market/p-227-----010107-0-0104-------1.html","mode":"furnace_raw","price_name":"唐山市场角钢价格行情","product":"角钢","spec":"50*50*5","origin":"正丰"}},
            {"cell_col_id":"Z","value":None,"name":"Channel steel 16# 日度","payload":{"url":"http://list1.mysteel.com/market/p-227-----010107-0-0104-------1.html","mode":"furnace_raw","price_name":"唐山市场槽钢价格行情","product":"槽钢","spec":"16#","origin":"金坤"}},
            {"cell_col_id":"AA","value":None,"name":"I beam steel 16# 日度","payload":{"url":"http://list1.mysteel.com/market/p-227-----010107-0-0104-------1.html","mode":"furnace_raw","price_name":"唐山市场工字钢价格行情","product":"工字钢","spec":"16#","origin":"国鑫"}},
            {"cell_col_id":"AU","value":None,"name":"SH Bengang SPHC","payload":{"url":"http://list1.mysteel.com/market/p-231-----010103-0-010101-------1.html","mode":"construction","price_name":"上海市场热轧板卷价格行情","product":"SPHC","spec":"2.75*1250*C","origin":"鞍钢/本钢"}},
            {"cell_col_id":"AR","value":None,"name":"Lecong Chenggang SPHC","payload":{"url":"http://list1.mysteel.com/market/p-231-----010103-0-0102010803-------1.html","mode":"construction","price_name":"乐从市场热轧板卷价格行情","spec":"3.0*1250*C","origin":"承钢"}},
            {"cell_col_id":"AH","value":None,"name":"Coking Coal","payload":{"url":"http://list.coal.glinfo.com/price/p-10043--050202--1.html","mode":"coal","price_name":"全国主要城市炼焦煤价格汇总","area":"唐山"}},
            {"cell_col_id":"AI","value":None,"name":"Coke","payload":{"url":"http://list1.mysteel.com/price/p-10039--050101--1.html","mode":"coal","price_name":"全国主要城市冶金焦价格汇总","area":"唐山"}}
    ...
    try:
        ...
        shfe_rebar_price = _get_sina_finance_future_price(url=shfe_rebar_nodate_url,suppress_exception=suppress_exception)
        logger.info("shfe_rebar_price: {} (sina.com.cn)".format(str(shfe_rebar_price)))
        shfe_hrc_price = _get_sina_finance_future_price(url=shfe_hrc_nodate_url,suppress_exception=suppress_exception)
